...
namespace Pizza
{
    public partial class MainForm : Form
    {
        ...
        {
            lblTotalPrice.Text = "$" + (Convert.ToSingle(nmPizzaNumber.Value) * CalculateTotalPrice()).ToString();
        }
        ...
        private void nmPizzaNumber_ValueChanged(object sender, EventArgs e)
        {
            UpdateTotalPrice();
        }
    }
